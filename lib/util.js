    ...
    try {
      ...
      const onExit = (proc, gAsyncResult) => {
        try {
          ...
          // const exceptionMessage = e.toString();
          // const error = 'An error was received in the exit handler for running external commands.';
          // new Error('An error was received in the exit handler for running external commands.')

          processExitedReject({ ...e, ...result });
        }
      };
